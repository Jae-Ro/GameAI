...
public class MyLevel extends Level {
    ...
    // same chromosome twice, the same level gets generated, even though the
    // chromosome
    ...
    /*
     * Converts the given MyDNA into a level. This function has been implemented for
     * you using the DNA characters defined in MyDNA.java. However, you may
     * optionally choose to modify it and/or create an alternate DNA representation.
     * 
     * In the representatino provided, every gene is represented as two characters.
     * 
     * The first character is one of
     * MyDNA.{STRAIGHT_CHAR,GAP_CHAR,COINS_CHAR,HILL_CHAR,MONSTERS_CHAR} which
     * represents the span type.
     * 
     * The second char is a number 0 through 9 indicating the length of the span.
     * The gene is decoded in order to invoke member functions (e.g. straight) that
     * modify the level as indicated.
     */
    public void create(MyDNA dna, int type) {
        ...
        for (int gene = 0; gene < dna.numGenes; gene++) {
            ...
            // System.out.println("C1: " + c1 + " C2: " + c2 + " " + n);
            switch (c1) {
    ...
    private int gap(int start, int length) {
        Random rand = new Random(this.random.nextInt());
    ...
    // A built in function for adding a line of enemies at a given height (y) and
    // difficulty
    public void addEnemyLine(int x0, int x1, int y, int difficulty) {
        for (int x = x0; x < x1; x++) {
            if (random.nextInt(35) < difficulty + 1) {
                ...
                setSpriteTemplate(x, y, new SpriteTemplate(type, random.nextInt(35) < difficulty));// Second boolean
                                                                                                   // value determines
                                                                                                   // if enemy is flying
                ENEMIES++;
            }
    ...
    // A built in function for building a tube (difficulty determines chance of
    // flower spawn)
